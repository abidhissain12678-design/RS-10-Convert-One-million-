...
router.post('/request-withdrawal', authmiddleware_1.authMiddleware, paymentController_1.requestWithdrawal);
router.post('/request-task-withdrawal', authmiddleware_1.authMiddleware, paymentController_1.requestTaskWithdrawal);
...
router.post('/reject-payment', paymentController_1.rejectPayment);
