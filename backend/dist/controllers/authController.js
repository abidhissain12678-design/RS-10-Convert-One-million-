...
exports.getReferredUsers = exports.requestActivation = exports.resetPassword = exports.verifyOTP = exports.forgotPassword = exports.updatePassword = exports.getUser = exports.adminLogin = exports.login = exports.register = exports.getMe = void 0;
...
const register = async (req, res) => {
    try {
        ...
        const user = new User_1.default({
            ...
            referralCount: 0,
            totalNetworkSize: 0,
            networkReferrals: Array.from({ length: 11 }, (_, i) => ({ position: i + 1, referralCode: `${username}-m${i + 1}`, status: 'locked' })),
        ...
        if (referredBy) {
            ...
            if (referrer) {
                ...
                console.log('Updated networkReferrals:', referrer.networkReferrals.map((r, i) => ({ pos: i + 1, status: r.status, code: r.referralCode })));
            }
            else {
...
const getReferredUsers = async (req, res) => {
    try {
        ...
        const referredUsers = await User_1.default.find({ username: { $in: user.referredUsers } });
