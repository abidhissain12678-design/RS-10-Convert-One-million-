  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Million Hub Earn Money Tasks Card */}
        <section style={{
          padding: '40px 15px',
          background: 'rgba(15, 20, 25, 0.95)',
          backdropFilter: 'blur(10px)',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  COMPLETE SIMPLE TASK and earn money instantaly. MINIMUM PAY OUT RS100. Earn Money Online CARD ky nichy AND NETWORK YOUR PATH KY OPAR.
                </p>
              </div>
            </div>
          </div>
